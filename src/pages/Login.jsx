...
export default function Login() {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-gradient-to-br from-sky-500 via-sky-600 to-fuchsia-500 overflow-hidden">
      ...
      <div className="relative w-full max-w-md bg-white/80 backdrop-blur-lg shadow-2xl rounded-3xl p-10 border border-white/30 z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-sky-500 to-fuchsia-500 text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-2"
          >
